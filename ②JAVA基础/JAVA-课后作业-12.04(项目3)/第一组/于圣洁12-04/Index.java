...
public class Index {
	public static void main(String[] args) {
		...
		while(true){
			System.out.println("请输入1.录入学生信息2.显示所有学生信息3.查询最高分4.停止");
			int num=sc.nextInt();
			if(num==1){
				System.out.println("请输入信息，格式为：姓名,编号,语文成绩,数学成绩,英语成绩");
				String str =sc.next();
				...
				for(Student a:list){
					...
					while(true){
						System.out.println("1.总分最高分是2.数学最高分是3.语文最高分是4.英语最高分是5.返回上一层");
						int x=sc.nextInt();
						if(x==1){
							int max=0;
						    String name="";
